document.addEventListener('DOMContentLoaded', function () {
  ...
  function applyInitialStyles(el) {
    ...
    const animationType = el.dataset.animate || (el.classList.contains('slide-up') ? 'slide-up' : (el.classList.contains('slide-in') ? 'slide-in' : 'fade'));
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יחזקאל אביחיל שירותי חשבונאות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd51d7fb8-2bb8-47ab-9aca-8ac06cafd625',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd51d7fb8-2bb8-47ab-9aca-8ac06cafd625';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd51d7fb8-2bb8-47ab-9aca-8ac06cafd625';
